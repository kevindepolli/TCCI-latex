...
\titulo{Detecção de Deep Fakes em Tempo Real: Uma Abordagem Multi Domínio Através da Fusão de Análises Espaciais, Temporais e de Frequência}
\autor{Kevin Depolli Costa Florindo}
\local{Alegre, ES}
\data{\the\year}
\orientador{Prof. D. Sc. Jacson Rodrigues Correia da Silva}
...
\include{capitulos/ch2-revisao}
\include{capitulos/ch3-metodologia}
\include{capitulos/ch4-resultados}
\include{capitulos/ch5-referencias}
\include{capitulos/ch6-cronograma}
